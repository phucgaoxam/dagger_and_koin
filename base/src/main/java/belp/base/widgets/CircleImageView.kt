...
class CircleImageView : AppCompatImageView, ILoadingImageView {
    ...
    constructor(context: Context, attrs: AttributeSet?, defStyleAttr: Int) : super(context, attrs, defStyleAttr) {
        ...
        mBorderWidth = a.getDimensionPixelSize(R.styleable.JavaCircelImageView_jciv_border_width, DEFAULT_BORDER_WIDTH)
        mBorderColor = a.getColor(R.styleable.JavaCircelImageView_jciv_border_color, DEFAULT_BORDER_COLOR)
        mBorderOverlay = a.getBoolean(R.styleable.JavaCircelImageView_jciv_border_overlay, DEFAULT_BORDER_OVERLAY)
        mDisableCircularTransformation =
                a.getBoolean(R.styleable.JavaCircelImageView_j_disable_circular, DEFAULT_DISABLE_CIRCULAR)
        mSquareFollowHeight =
                a.getBoolean(R.styleable.JavaCircelImageView_jciv_follow_height, DEFAULT_SQUARE_FOLLOW_HEIGHT)
        mFillColor = a.getColor(R.styleable.JavaCircelImageView_jciv_fill_color, DEFAULT_FILL_COLOR)
