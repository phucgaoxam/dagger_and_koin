...
import belp.base.R
import belp.base.databinding.DialogInformBinding
...
class InformDialog(context: Context) : BaseDialog<DialogInformBinding>(context) {
    ...
    private fun setupTexts() {
        ...
        val title = when (mInformType) {
            InformType.SUCCESS -> context.getString(R.string.success)
            InformType.WARNING -> context.getString(R.string.warning)
    ...
    fun show(
        onConfirmListener: OnConfirmListener? = null, title: String? = null,
